...
Signed_Number compare_null_terminated_words(Number16* words1, Number16* words2)
{
	Signed_Number difference;

	while(*words1 && *words2) {
		difference = (Signed_Number)*words1 - (Signed_Number)*words2;
	...
	return (Signed_Number)*words1 - (Signed_Number)*words2;
}
