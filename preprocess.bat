...
@"%TCC_PATH%tcc.exe" -E -w -nostdlib -DDEBUG -D__WIN32__ "-I%TCC_PATH%include\level0" "-I%TCC_PATH%include\level1" "-I%TCC_PATH%include\level2" ^
	%* ^
